        ...
        <section className="infos">
          <ul>
            ...
            {/* <li>
              ...
              <h3>Hébergement</h3>
              <p>
                OVH <br /> 2 rue Kellermann 59100 Roubaix <br />
                <a
            ...
            <li>
              ...
              <p>
                ...
                <a href="https://www.maxencevallee.com/">maxencevallee.com</a>{" "}
              ...
              <p>
                ...
                technique peut être toutefois décidée par Maxence VALLÉE, qui
              ...
              <p>
                Le site{" "}
                <a href="https://www.maxencevallee.com/">maxencevallee.com</a>{" "}
                est mis à jour régulièrement par Maxence VALLÉE. De la même
            ...
            <li>
              ...
              <p>
                Le site{" "}
                <a href="https://www.maxencevallee.com/">maxencevallee.com</a> a
                pour objet de fournir une information concernant l’ensemble des
                activités de l’entreprise.
              </p>
              <p>
                Maxence VALLÉE s’efforce de fournir sur le site
                <a href="https://www.maxencevallee.com/">
                  maxencevallee.com
                </a>{" "}
            ...
            <li>
              <h2>4. Limitations contracutelles sur les données techniques</h2>
              <p>Le site utilise la technologie JavaScript.</p>
              <p>
                Maxence VALLÉE ne pourra être tenu responsable de dommages
            ...
            <li>
              ...
              <p>
                Maxence VALLÉE est propriétaire des droits de propriété
                intellectuelle ou détient les droits d’usage sur tous les
                éléments accessibles sur le site, notamment les textes, images,
                graphismes, logos, icônes, sons, logiciels. Certains de ces
                éléments sont des ressources libres de droits.
              </p>
              <p>
                Toute reproduction, représentation, modification, publication,
                adaptation de tout ou partie des éléments du site, quel que soit
                le moyen ou le procédé utilisé, est interdite.
              </p>
              <p>
                ...
                poursuivie conformément aux dispositions légales du Code de
            ...
            <li>
              ...
              <p>
                Maxence VALLÉE ne pourra être tenue responsable des dommages
              ...
              <p>
                Maxence VALLÉE ne pourra également être tenue responsable des
                dommages indirects (par exemple, une perte de marché)
              ...
              <p>
                ...
                Maxence VALLÉE se réserve le droit de supprimer, sans mise en
                ...
                données. Le cas échéant, Maxence VALLÉE se réserve également la
            ...
            <li>
              ...
              <p>
                En tout état de cause Maxence VALLÉE ne collecte des
                ...
                Il est alors précisé à l’utilisateur du site{" "}
                <a href="https://www.maxencevallee.com/">maxencevallee.com</a>{" "}
              ...
              <p>
                ...
                l’hypothèse du rachat de Maxence VALLÉE et de ses droits
            ...
            <li>
              ...
              <p>
                ...
                sites, mis en place avec l’autorisation de Maxence VALLÉE.
                Cependant, Maxence VALLÉE n’a pas la possibilité de vérifier le
              ...
              <p>
                ...
                petite taille, qui ne permet pas l’identification de
              ...
              <p>
                Sous Microsoft Edge : onglet outil (pictogramme en forme de
